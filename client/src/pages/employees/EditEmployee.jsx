...
const EditEmployee = () => {
    ...
    try {
      ...
      if (employeeResponse.data.success) {
        ...
        if (employee.bankAccounts && employee.bankAccounts.length > 0) {
          setBankAccounts(employee.bankAccounts.map(account => ({
            id: account.id,
    ...
    return (
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center h-64">
          ...
          <span className="ml-2 text-sm text-gray-600">Loading employee data...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6">
        <div className="mb-2">
          <h1 className="text-lg font-bold text-gray-900">Edit Employee</h1>
        </div>
        <p className="mt-1 text-xs text-gray-500">
          Update employee information and banking details
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-gray-300 px-3 py-2 text-xs focus:outline-none focus:ring-gray-500 focus:border-gray-500 bg-gray-50"
                readOnly
              />
            </div>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Error Updating Employee</h3>
              <p className="text-xs text-gray-500 mb-4">
