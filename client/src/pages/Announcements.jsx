        ...
        <div className="mb-4 md:mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-600">Manage and publish announcements for students and employees</p>
            </div>
            <div className="flex gap-2">
              <button
                onClick={() => navigate('/dashboard/announcements/add')}
                className="bg-blue-600 text-white px-3 py-2 text-xs md:text-sm hover:bg-blue-700 flex items-center w-full sm:w-auto justify-center"
              >
        ...
        <div className="bg-white border border-gray-200 shadow">
          ...
          {announcements.length === 0 ? (
            <div className="text-center py-8 md:py-12 px-4">
              ...
              <p className="text-gray-500 text-xs md:text-sm mb-4">Create your first announcement to get started</p>
              <button
                onClick={() => navigate('/dashboard/announcements/add')}
                className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-xs md:text-sm font-medium hover:bg-blue-700"
              >
            ...
            <>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                          <h3 className="font-semibold text-gray-900 text-sm truncate">{announcement.title}</h3>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs text-gray-500">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="truncate">{announcement.target_name}</span>
                          </div>
                          <div className="flex items-center gap-1">
              ...
              {pagination.total_pages > 1 && (
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-3 md:px-4 py-3 border-t border-gray-200">
