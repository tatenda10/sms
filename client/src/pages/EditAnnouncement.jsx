...
const EditAnnouncement = () => {
  ...
  const loadAnnouncementData = async () => {
    try {
      ...
      const response = await axios.get(`${BASE_URL}/announcements/${id}`, { headers: authHeaders });
      
      const announcement = response.data;
      setFormData({
        title: announcement.title || '',
        content: announcement.content || '',
        announcement_type: announcement.announcement_type || 'student',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${BASE_URL}/announcements/${id}`, submitData, { headers: authHeaders });
      ...
      <div className="min-h-screen bg-gray-50 py-4">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-600 mt-2">Loading announcement...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-lg font-bold text-gray-900">Edit Announcement</h1>
              <p className="text-xs text-gray-600">Update announcement details</p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 text-xs focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500"
                  >
                    <option value="all">All {formData.announcement_type === 'student' ? 'Students' : 'Employees'}</option>
